...
Composition Engine](https://docs.pavona.org/book/util/ace.html) (ACE). Run it from the repo top:
...
[always runs ACE through the Makefile, never `topgen.py` directly](https://docs.pavona.org/book/doc/getting_started/intro_hardware.html#the-top-generation-flow).
